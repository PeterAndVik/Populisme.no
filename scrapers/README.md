...
This guide explains everything a you need to add a new scraper and processing script.
...
- How to Add a New Scraper (Step by Step)
  - Understanding the Scraper Template (Detailed Explanation)
...
Your project is organized into clear folders:
